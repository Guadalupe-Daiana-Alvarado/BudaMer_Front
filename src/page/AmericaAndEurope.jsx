        ...
        <div className='bg-green-300 bg-opacity-50 min-h-screen'>
            ...
            <div className='bg-green-300 md:pb-50 bg-opacity-50 w-full min-h-3/4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 p-6'>
                ...
                <div class=" h-fit bg-green-300 p-2">
                    ...
                    <div class="bg-gray-100 min-h-3/4 p-2 flex flex-col justify-between">
                        <h5 class="text-2xl font-bold pl-4">Beneficios en tu cuerpo cuando haces meditación en la mañana:</h5>
                        <p className="text-gray-600 text-lg min-h-5/6 p-3">
                            ...
                            En general, es simplemente un tiempo que se reserva para respirar profundamente, centrar los pensamientos y ser testigo de los sentimientos.<br></br>
                             Y, aunque existen guías para la meditación, no hay una forma "incorrecta" de meditar, siempre que lo hagas lo mejor posible.<br></br>

                            Por supuesto, a medida que sigas profundizando en la meditación simple como práctica, hay mucho más que descubrir.<br></br> 
                            Por ahora, nos centraremos en lo básico.<br></br>
                    ...
                    <div class="flex gap-1 text-base pl-6 py-2 items-center bg-green-100">
                        <small class="text-gray-500">Marce - 25/05/2019</small>
                    </div>
                </div>
                ...
                <div class=" h-fit bg-green-300 p-2">
                    ...
                    <div class="bg-gray-100 min-h-3/4 p-2 flex flex-col justify-between">
                        ...
                        <p className="text-gray-600 text-lg min-h-5/6 p-3">
                            1) Ponte en una posición cómoda (sentado, de pie o acostado). 
                            ...
                            acuéstate en un tapete de yoga.<br></br>
                            2) Empieza de menos a más: Te recomendamos empezar con meditaciones
                            ...
                            Baja la aplicación aplicacion para encontrar  meditaciones guiadas que te ayudarán y 
                            enseñarán a hacer las cosas bien.<br></br>
                            ...
                            Puedes cocinar, bañarte, hacer tu rutina de skincare, <br></br>
                    ...
                    <div class="flex gap-1 text-base pl-6 py-2 items-center bg-green-100">
                        <small class="text-gray-500">Merce - 25/07/2023</small>
                    </div>
                </div>
